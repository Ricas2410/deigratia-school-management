#!/usr/bin/env python
"""
Script to populate website content using existing images in media folder
Run this with: python manage.py shell < populate_website_content.py
"""
...
def populate_hero_slides():
    ...
    for data in hero_data:
        ...
        if created:
            ...
            print(f"- Hero slide already exists: {slide.title}")
...
def populate_gallery():
    ...
    for data in gallery_data:
        ...
        if created:
            ...
            print(f"- Gallery image already exists: {image.title}")
...
def populate_events():
    ...
    for cat_data in categories_data:
        ...
        if created:
            print(f"✓ Created event category: {category.name}")
...
def populate_page_sections():
    ...
    for data in sections_data:
        ...
        if created:
            print(f"✓ Created page section: {section.section_type}")
        else:
            print(f"- Page section already exists: {section.section_type}")

def main():
    """Main function to populate all website content"""
    print("🚀 Starting website content population...")
    print("=" * 50)
    ...
    try:
        ...
        print("\n" + "=" * 50)
        print("✅ Website content population completed successfully!")
        print("\nYour website now has:")
        print(f"- {HeroSlide.objects.count()} Hero slides")
        print(f"- {GalleryImage.objects.count()} Gallery images")
        print(f"- {StaffMember.objects.count()} Staff members")
        print(f"- {Event.objects.count()} Events")
        print(f"- {Announcement.objects.count()} Announcements")
        print(f"- {Testimonial.objects.count()} Testimonials")
        print(f"- {PageSection.objects.count()} Page sections")

        print("\n🌟 Your images are now being used across the website!")
        print("Visit your website to see all the content in action.")
